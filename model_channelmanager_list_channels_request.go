...
type _ChannelmanagerListChannelsRequest ChannelmanagerListChannelsRequest
...
func NewChannelmanagerListChannelsRequest(tenantId string) *ChannelmanagerListChannelsRequest {
...
func (o *ChannelmanagerListChannelsRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varChannelmanagerListChannelsRequest := _ChannelmanagerListChannelsRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varChannelmanagerListChannelsRequest)

	if err != nil {
		return err
	}

	*o = ChannelmanagerListChannelsRequest(varChannelmanagerListChannelsRequest)
